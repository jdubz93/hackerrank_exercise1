...
std::vector<int> countingSort(std::vector<int> arr) {
    ...
    // return array with max size 100
    std::vector<int> new_array;
    for(int i = 0; i < 100; i++) {
        // std::cout << count[i] << " ";
        new_array.push_back(count[i]);
    }
    // std::cout << '\n';
